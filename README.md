...
| Демо: фото → top-3 + уверенность | `/recognize` |
...
2. «Распознать» — загрузить фото еды, получить top-3
3. Включить «Сравнить все 5 моделей» — показать разницу во времени
4. «Архитектуры» — таблица метрик для отчёта
5. «Confusion Matrix» — матрица ошибок
6. Скачать PDF/Excel для отчёта
